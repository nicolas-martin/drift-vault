...
export declare enum VaultClass {
    NORMAL = 0,
    TRUSTED = 1
}
export declare function isNormalVaultClass(vaultClass: number | VaultClass): boolean;
export declare function isTrustedVaultClass(vaultClass: number | VaultClass): boolean;
export declare enum FuelDistributionMode {
    UsersOnly = 0,
    UsersAndManager = 1
}
export declare enum FeeUpdateStatus {
    None = 0,
    PendingFeeUpdate = 1
}
export declare function hasPendingFeeUpdate(status: number | FeeUpdateStatus): boolean;
...
export declare class FeeUpdateAction {
    static readonly PENDING: {
        pending: {};
    };
    static readonly APPLIED: {
        applied: {};
    };
}
