...
class EVMUtils {
     ...
     */
    static convertSurgeUpdateToEvmFormat(surgeUpdate, options) {
        var _a, _b;
        const minOracleSamples = (_a = options === null || options === void 0 ? void 0 : options.minOracleSamples) !== null && _a !== void 0 ? _a : 1;
        // Extract data from surge update
        const feedValues = (_b = surgeUpdate.feed_values) !== null && _b !== void 0 ? _b : [];
