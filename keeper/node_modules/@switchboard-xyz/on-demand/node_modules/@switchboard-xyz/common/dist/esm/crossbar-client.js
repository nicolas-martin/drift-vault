...
export class CrossbarClient {
     ...
     */
    async resolveEVMRandomness({ chainId, randomnessId, timestamp, minStalenessSeconds, oracle, }) {
        try {
            return await axios
                ...
                .then(resp => { var _a, _b; return (_b = (_a = resp.data) === null || _a === void 0 ? void 0 : _a.data) !== null && _b !== void 0 ? _b : resp.data; });
        }
        catch (err) {
            if (!axios.isAxiosError(err))
                throw err;
            ...
            if (this.verbose)
                console.error(`${response.status}: ${response.data}`);
            throw new Error(`Bad Crossbar resolveEVMRandomness response: ${response.status} - ${JSON.stringify(response.data)}`);
        }
    }
    /**
