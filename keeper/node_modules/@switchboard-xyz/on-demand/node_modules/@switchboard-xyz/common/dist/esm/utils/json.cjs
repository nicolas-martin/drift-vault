...
const switchboard_decimal_js_1 = require("../switchboard-decimal.cjs");
...
function jsonReplacers(key, value) {
    ...
    // Switchboard Decimal
    if (value instanceof switchboard_decimal_js_1.SwitchboardDecimal ||
        (value &&
            typeof value === 'object' &&
            'mantissa' in value &&
            'scale' in value)) {
        const swbDecimal = new switchboard_decimal_js_1.SwitchboardDecimal(value.mantissa, value.scale);
